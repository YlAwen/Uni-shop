...
var _default = {
  ...
  mutations: {
    ...
    updateGoodsState: function updateGoodsState(state, goods) {
      var result = state.cart.find(function (x) {
    ...
    // 更新购物车列表
    updateGoodsList: function updateGoodsList(state, goods) {
      var newCart = [];
    ...
    updateAllState: function updateAllState(state, val) {
  ...
  getters: {
    ...
    getPriceSum: function getPriceSum(state) {
      var sum = 0;
      state.cart.forEach(function (item) {
        if (item.goods_state) {
...
var _default = {
  computed: _objectSpread(_objectSpread({}, (0, _vuex.mapState)("m_cart", ["cart"])), (0, _vuex.mapGetters)("m_cart", ["checkedCount"])),
  methods: {
